...
Для реализации описанной схемы нужно устройство - USB-TTL переходник, одним концом включаемый в USB порт хоста, другим - к UART порту целевого МК.

### Обзор USB-TTL переходников
| Устройство | Сайт | Комментарий  |
|------------|------|--------------|
| FTDI FT232 |*|*|
| CH 340G    |*|*|
| CP 2102    |*|*|
